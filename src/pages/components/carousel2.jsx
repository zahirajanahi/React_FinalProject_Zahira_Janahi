...
function CarouselTwo() {
  ...
  return (
    <div className="slider-container overflow-hidden pt-10 relative pb-28">
        ...
        {EightProducts.map((product, index) => (
          <div key={index} className='px-2 '>
            <div className="relative group overflow-hidden bg-white  h-[52vh] w-[17vw] hover:bg-gray-500 transition-all duration-500">
              <img src={Images[product.img]} alt={product.name} className="h-[52vh] w-[17vw] object-cover group-hover:opacity-40 transition-opacity duration-300" />
      ...
      <button onClick={handlePrev} className="absolute left-[80px] top-1/2 transform -translate-y-1/2 text-gray-300 text-5xl  p-3  ">
        <GrFormPrevious />
      </button>
      <button onClick={handleNext} className="absolute right-[100px] top-1/2 transform -translate-y-1/2  text-gray-300 text-5xl p-3  " >
